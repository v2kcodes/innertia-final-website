    ...
    return (
      <div className={cn("relative", className)}>
        <motion.button
          ...
          className={cn(
            "flex items-center space-x-2 px-3 py-2 rounded-lg bg-[#25D366] hover:bg-[#128C7E] text-white transition-all duration-300 text-sm",
            buttonClassName
          )}
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className={cn(
                "absolute top-full left-0 mt-2 min-w-[220px] bg-white rounded-xl shadow-xl border border-gray-200 z-50 overflow-hidden",
                dropdownClassName
              )}
            >
              {contacts.map((contact, index) => (
                ...
                >
                  <div className="w-8 h-8 rounded-full bg-gradient-to-r from-[#25D366] to-[#128C7E] flex items-center justify-center">
